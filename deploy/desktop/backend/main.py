...
CSV_COLUMNS = [
    ...
    "email",
    "tecnico",
    "checklist_solucao_registrada",
    "checklist_usuario_validou",
    "checklist_evidencia_coletada",
    "checklist_equipamento_ok",
    "feedback",
    "criado_em",
    "atualizado_em",
    "resolvido_em",
...
def _ticket_csv_row(ticket) -> list[str | int]:
    ...
    return [
        ...
        "sim" if ticket.checklist_solution_registered else "não",
        "sim" if ticket.checklist_user_validated else "não",
        "sim" if ticket.checklist_evidence_collected else "não",
        "sim" if ticket.checklist_equipment_ok else "não",
        ticket.feedback or "",
...
def list_tickets(
    ...
    impact: str | None = Query(None, description="Filtrar por impacto operacional"),
    support_level: str | None = Query(None, description="Filtrar por nível de suporte N1/N2"),
